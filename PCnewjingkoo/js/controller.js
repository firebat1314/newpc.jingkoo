...
angular.module('myApp.controllers', [
    ...
    'ShopDetailCutModule',
    'JumpModule',
    'ShopListDistributionModule',
    'ShopDetailDistributionModule',
    'CheckoutDistributionModule',
    'OrderListDistributionModule',
    'orderDetailDistributionModule'
            ...
            $http({
                ...
                if (data.status) {
                    layer.confirm(data.info, {
                        ...
                        $state.go('registerCompany', { user_id: data.data.user_id });
                        layer.close(index);
                    }, function (index) {
                        layer.close(index);
                        $state.go('login');
