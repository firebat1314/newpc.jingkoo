                ...
                .success(function(data) {
                    ...
                    if(data.status){
                            ...
                            .success(function(data) {
                                ...
                                layer.msg('更换地址成功', {icon: 1,time:500});
                                $scope.shopDetailFn();
                            })
                    }else{
                        layer.msg('更换地址失败', {icon: 2,time:500});
                    }
                })
        };
        //商品切换销售区域
        ...
        $scope.addTr = function(){
            ...
            console.log($scope.goodsSpectaclesCarParams);
                if(!$scope.goodsSpectaclesCarParams.goods.zhujing[$scope.arr.length-1]&&!$scope.goodsSpectaclesCarParams.goods.qiujing[$scope.arr.length-1]){
                     layer.msg('商品球镜柱镜属性不能为空',{time:500});
                }else{
                    $scope.arr.push({});
                }
        };
        ...
        (function(){
            ...
            document.onmousedown = function(event) {
                ...
                document.onmousemove = function() {
                    ...
                    if (isSelect) {
                        ...
                        if(document.body.scrollTop > top_) {
                            selDiv.style.height = Math.abs(_y + (document.body.scrollTop - startY - top_)) + "px";
                        }else{
            ...
            function showSelDiv(arr) {
                ...
                if(count > 0){
                    ...
                    layer.prompt({title: '共选择' + count + "种,请填写数量", formType: 0,cancel: function(index, layero){
                        //if(confirm('确定要关闭么')){
